...
exports.toHandlerUndecoded = exports.toHandlerRaw = exports.toHandlerNoStream = exports.toHandler = exports.provideServiceEffect = exports.provideService = exports.make = exports.isRpcRouter = exports.TypeId = void 0;
 ...
 * @category type ids
 */
const TypeId = exports.TypeId = /*#__PURE__*/Symbol.for("@effect/rpc/RpcRouter");
/**
 * @since 1.0.0
 * @category refinements
 */
const isRpcRouter = u => Predicate.hasProperty(u, TypeId);
exports.isRpcRouter = isRpcRouter;
const fromSet = rpcs => ({
  [TypeId]: TypeId,
  rpcs,
  pipe() {
 ...
 */
const toHandler = exports.toHandler = /*#__PURE__*/(0, _Function.dual)(args => isRpcRouter(args[0]), (router, options) => {
  ...
  const getEncode = (0, _rpc.withRequestTag)(req => Schema.encode(Schema.exitSchema(req)));
  const getEncodeChunk = (0, _rpc.withRequestTag)(req => Schema.encode(Schema.Chunk(Schema.exitSchema(req))));
 ...
 * @category combinators
 */
const toHandlerNoStream = exports.toHandlerNoStream = /*#__PURE__*/(0, _Function.dual)(args => isRpcRouter(args[0]), (router, options) => {
  const spanPrefix = options?.spanPrefix ?? "Rpc.router ";
...
const toHandlerUndecoded = router => {
  ...
  const getEncode = (0, _rpc.withRequestTag)(req => Schema.encode(Schema.successSchema(req)));
  const getEncodeChunk = (0, _rpc.withRequestTag)(req => Schema.encode(Schema.ChunkFromSelf(Schema.successSchema(req))));
  return request => {
