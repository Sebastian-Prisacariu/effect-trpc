 ...
 * @category type ids
 */
export const TypeId = /*#__PURE__*/Symbol.for("@effect/rpc/RpcRouter");
/**
 * @since 1.0.0
 * @category refinements
 */
export const isRpcRouter = u => Predicate.hasProperty(u, TypeId);
const fromSet = rpcs => ({
  [TypeId]: TypeId,
  rpcs,
  pipe() {
 ...
 */
export const toHandler = /*#__PURE__*/dual(args => isRpcRouter(args[0]), (router, options) => {
 ...
 * @category combinators
 */
export const toHandlerNoStream = /*#__PURE__*/dual(args => isRpcRouter(args[0]), (router, options) => {
  const spanPrefix = options?.spanPrefix ?? "Rpc.router ";
