...
export declare namespace Vitest {
     ...
     * @since 1.0.0
     */
    type Arbitraries = Array<Schema.Schema.Any | FastCheck.Arbitrary<any>> | {
    ...
    interface Methods<R = never> extends API {
        ...
        readonly prop: <const Arbs extends Arbitraries>(name: string, arbitraries: Arbs, self: (properties: {
            [K in keyof Arbs]: K extends FastCheck.Arbitrary<infer T> ? T : Schema.Schema.Type<Arbs[K]>;
 ...
 * @since 1.0.0
 */
export declare const prop: <const Arbs extends Vitest.Arbitraries>(name: string, arbitraries: Arbs, self: (properties: {
    [K in keyof Arbs]: K extends FastCheck.Arbitrary<infer T> ? T : Schema.Schema.Type<Arbs[K]>;
}, ctx: V.TaskContext<V.RunnerTestCase<{}>> & V.TestContext) => void, timeout?: number | V.TestOptions) => void;
/**
 * @since 1.0.0
