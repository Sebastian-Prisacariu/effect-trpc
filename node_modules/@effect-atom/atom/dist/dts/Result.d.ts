 ...
 * @category Schemas
 */
export interface Schema<Success extends Schema_.Schema.All, Error extends Schema_.Schema.All> extends Schema_.Schema<Result<Success["Type"], Error["Type"]>, Encoded<Success["Encoded"], Error["Encoded"]>, Success["Context"] | Error["Context"]> {
}
/**
 * @since 1.0.0
 * @category Schemas
