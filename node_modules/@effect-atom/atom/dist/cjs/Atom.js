...
exports.writable = exports.withServerValueInitial = exports.withServerValue = exports.withReactivity = exports.withLabel = exports.withFallback = exports.windowFocusSignal = exports.update = exports.transform = exports.toStreamResult = exports.toStream = exports.subscriptionRef = exports.subscribable = exports.setLazy = exports.setIdleTTL = exports.set = exports.serializable = exports.searchParam = exports.runtime = exports.refreshOnWindowFocus = exports.refresh = exports.readable = exports.pull = exports.optimisticFn = exports.optimistic = exports.modify = exports.mapResult = exports.map = exports.makeRefreshOnSignal = exports.make = exports.kvs = exports.keepAlive = exports.isWritable = exports.isSerializable = exports.isAtom = exports.initialValue = exports.getServerValue = exports.getResult = exports.get = exports.fnSync = exports.fn = exports.family = exports.defaultMemoMap = exports.debounce = exports.context = exports.batch = exports.autoDispose = exports.ServerValueTypeId = exports.SerializableTypeId = exports.Reset = exports.Interrupt = void 0;
...
const TypeId = "~effect-atom/atom/Atom";
/**
 * @since 1.0.0
 * @category Guards
 */
const isAtom = u => (0, _Predicate.hasProperty)(u, TypeId);
exports.isAtom = isAtom;
const WritableTypeId = "~effect-atom/atom/Atom/Writable";
/**
 * @since 1.0.0
 * @category combinators
 */
const setIdleTTL = exports.setIdleTTL = /*#__PURE__*/(0, _Function.dual)(2, (self, durationInput) => {
...
const makeRead = (arg, options) => {
  if (typeof arg === "function" && !Effect.isEffect(arg) && !(Stream.StreamTypeId in arg)) {
    ...
    return function (get, providedRuntime) {
      ...
      if ((0, _Predicate.isObject)(value)) {
        if (isDataType(value)) {
          return value;
  ...
  } else if ((0, _Predicate.isObject)(arg)) {
    if (isDataType(arg)) {
      return state(arg);
 ...
 * @category Reactivity
 */
const withReactivity = exports.withReactivity = runtime.withReactivity;
// -----------------------------------------------------------------------------
// constructors - stream
// -----------------------------------------------------------------------------
...
function makeStream(ctx, stream, initialValue, runtime = Runtime.defaultRuntime) {
  ...
  const cancel = (0, _runtime.runCallbackSync)(registryRuntime)(Channel.runDrain(Channel.pipeTo(Stream.toChannel(stream), writer)), _Function.constVoid, false);
  if (cancel !== undefined) {
    ctx.addFinalizer(cancel);
  }
 ...
 * @category symbols
 */
const Interrupt = exports.Interrupt = /*#__PURE__*/Symbol.for("@effect-atom/atom/Atom/Interrupt");
/**
 * @since 1.0.0
 * @category constructors
 */
...
const kvs = options => {
  ...
  const resultAtom = options.runtime.atom(Effect.flatMap(KeyValueStore.KeyValueStore, store => store.forSchema(options.schema).get(options.key)));
  return writable(get => {
    get.mount(setAtom);
